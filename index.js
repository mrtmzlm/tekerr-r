...
const database = {
    ...
    "osmanli_kurulus": [
        { word: "Osmanlı ile Bizans arasında yapılan ilk savaş (Osman Bey)?", meaning: "Koyunhisar (Bafeus) Savaşı (KURULUŞ)" },
        { word: "Bursa'nın fethedilip başkent yapıldığı dönem?", meaning: "Orhan Bey (KURULUŞ)" },
        { word: "Osmanlı'nın Rumeli'ye geçtiği ilk toprak parçası?", meaning: "Çimpe Kalesi (KURULUŞ)" },
        { word: "İlk Osmanlı-Haçlı savaşı?", meaning: "Sırpsındığı Savaşı (KURULUŞ)" },
        { word: "I. Murat'ın şehit düştüğü ve ilk kez top kullanılan savaş?", meaning: "I. Kosova Savaşı (KURULUŞ)" },
        { word: "Yıldırım Bayezid'in Haçlıları bozguna uğrattığı ve 'Sultan-ı İklimi Rum' unvanını aldığı savaş?", meaning: "Niğbolu Savaşı (KURULUŞ)" },
    ...
    "osmanli_yukselis": [
        ...
        { word: "Fatih Sultan Mehmet'in Akkoyunlu hükümdarı Uzun Hasan'ı yendiği savaş?", meaning: "Otlukbeli Savaşı (YÜKSELİŞ)" },
        { word: "Kırım'ın fethiyle (Fatih Dönemi) ne gerçekleşmiştir?", meaning: "Karadeniz Türk gölü haline geldi. (YÜKSELİŞ)" },
        { word: "Anadolu Türk siyasi birliğinin kesin olarak sağlandığı savaş?", meaning: "Turnadağ Savaşı (1515) (YÜKSELİŞ)" },
        { word: "Yavuz Sultan Selim'in Safevileri (Şah İsmail) yendiği savaş?", meaning: "Çaldıran Savaşı (YÜKSELİŞ)" },
        { word: "Memlüklerin yıkıldığı ve Halifeliğin Osmanlı'ya geçtiği savaşlar?", meaning: "Mercidabık ve Ridaniye (YÜKSELİŞ)" },
        { word: "Dünya tarihinin en kısa süren (2 saat) meydan muharebesi?", meaning: "Mohaç Meydan Muharebesi (Kanuni) (YÜKSELİŞ)" },
    ...
    "osmanli_duraklama": [
        ...
        { word: "Avusturya arşidükünün Osmanlı padişahına denk sayılacağı antlaşma?", meaning: "Zitvatorok Antlaşması (DURAKLAMA)" },
        { word: "Günümüz Türkiye-İran sınırını büyük ölçüde çizen antlaşma?", meaning: "Kasr-ı Şirin Antlaşması (DURAKLAMA)" },
        { word: "Osmanlı'nın batıda en geniş sınırlara ulaştığı antlaşma?", meaning: "Bucaş Antlaşması (DURAKLAMA)" },
        { word: "Osmanlı ordusunun 24 yılda alabildiği ada?", meaning: "Girit Adası (DURAKLAMA)" },
        { word: "Osmanlı'nın batıda taarruzdan savunmaya geçtiği büyük bozgun?", meaning: "II. Viyana Kuşatması (1683) (DURAKLAMA)" },
        { word: "Osmanlı'nın batıda büyük çapta toprak kaybettiği ilk antlaşma (Gerileme Başlangıcı)?", meaning: "Karlofça Antlaşması (DURAKLAMA)" }
    ],
    "osmanli_gerileme": [
        { word: "Rusya'nın Karadeniz'e inme fırsatı bulduğu antlaşma?", meaning: "İstanbul Antlaşması (1700) (GERİLEME)" },
        { word: "Rusya'ya verilen Azak Kalesi'nin geri alındığı antlaşma?", meaning: "Prut Antlaşması (GERİLEME)" },
        { word: "Batının üstünlüğünün kabul edildiği ve Lale Devri'nin başladığı antlaşma?", meaning: "Pasarofça Antlaşması (GERİLEME)" },
        { word: "Osmanlı'nın 18. yüzyılda imzaladığı son kazançlı antlaşma?", meaning: "Belgrad Antlaşması (GERİLEME)" },
        { word: "Rus donanmasının Osmanlı donanmasını yaktığı ilk olay (1770)?", meaning: "Çeşme Baskını (GERİLEME)" },
        { word: "Kırım'ın bağımsız olduğu antlaşma?", meaning: "Küçük Kaynarca Antlaşması (GERİLEME)" },
        { word: "Kırım'ın Rusya'ya ait olduğunun resmen kabul edildiği antlaşma?", meaning: "Yaş Antlaşması (GERİLEME)" }
    ],
    "osmanli_dagilma": [
        ...
        { word: "1809'da Osmanlı ile İngiltere arasında imzalanan antlaşma?", meaning: "Kale-i Sultaniye (Çanakkale) Antlaşması" },
        { word: "1812'de Rusya ile Osmanlı arasında imzalanan ve Sırplara ilk imtiyazı veren antlaşma?", meaning: "Bükreş Antlaşması" },
        { word: "1815 Viyana Kongresi’nde gündeme getirilen konu?", meaning: "Şark Meselesi (Şark Sorunu)" },
        { word: "1815'te Avrupa'da ulusçuluk isyanlarını bastırma amacını taşıyan dönem?", meaning: "Restorasyon Dönemi" },
        { word: "1820'de Aleksandr İpsilanti tarafından kurulan cemiyet?", meaning: "Filiki Eterya Cemiyeti" },
        { word: "1821'de başlayan isyan?", meaning: "Mora (Yunan) İsyanı" },
        { word: "Yunan isyanının çıkmasında etkili fikir akımı?", meaning: "Milliyetçilik" },
        ...
        { word: "Osmanlı Devleti'nin Kuzey Afrika'da kaybettiği ilk toprak?", meaning: "Cezayir" },
        { word: "Cezayir'i işgal eden devlet?", meaning: "Fransa" },
    ...
    "osmanli_20yy": [
        ...
        { word: "Mustafa Kemal'in tarih sahnesine çıktığı ilk olay?", meaning: "31 Mart Olayı (1909) (XX. YY)" },
        { word: "Kuzey Afrika'daki son toprak parçasının kaybedildiği antlaşma?", meaning: "Uşi Antlaşması (1912) (XX. YY)" },
        { word: "I. Balkan Savaşı'nda en karlı çıkan devlet?", meaning: "Bulgaristan (XX. YY)" },
        { word: "Osmanlı'nın I. Dünya Savaşı'ndan çekildiği ateşkes?", meaning: "Mondros Ateşkes Antlaşması (XX. YY)" },
        { word: "Osmanlı Devleti'nin hukuken sona ermesine yol açan gelişme?", meaning: "Saltanatın kaldırılması (1 Kasım 1922) (XX. YY)" }
    ],
    "islahat_17": [
...
let quizScore = 0;
let quizSourceCategory = ''; 

// Utility: Array karıştırma fonksiyonu
...
// ==========================================
// ==========================================
// QUIZ MODÜLÜ (TEST) - GÜNCELLENMİŞ HALİ
// ==========================================
// ==========================================
// QUIZ MODÜLÜ (TEST) - GÜNCELLENMİŞ
// ==========================================

// Islahat sorularında yanlış şık olarak sadece bu isimler gelecek
const islahatPadisahlari = [
    "II. Osman (Genç Osman)",
    "IV. Murat",
    "III. Ahmet",
    "I. Mahmut",
    ...
    "II. Abdülhamit",
    "V. Murat",
    "Tarhuncu Ahmet Paşa", // (Devlet adamı olduğu için şıklarda olması mantıklı)
    "Köprülü Mehmet Paşa"
];

function loadQuizQuestion(sourceMenu) {
    quizSourceCategory = sourceMenu;
    ...
    if (currentList.length === 0) {
        questionContainer.innerText = `Tebrikler! Quiz bitti. Toplam skorunuz: ${quizScore}`;
        optionsContainer.innerHTML = `<button class="draw-btn" onclick="goBackFromQuiz()">Menüye Dön</button>`;
        return;
    }
    
    // Rastgele bir soru seç ve listeden çıkar
    const randomIndex = Math.floor(Math.random() * currentList.length);
    const selectedQuestion = currentList.splice(randomIndex, 1)[0];
    
    questionContainer.innerText = selectedQuestion.word;
    const correctMeaning = selectedQuestion.meaning;

    // --- ŞIK HAVUZU AYARLAMA ---
    let wrongOptionsPool = [];

    if (sourceMenu === 'islahat_menu') {
        // Islahat testindeysek, yanlış şıkları SADECE yukarıdaki Padişah listesinden seç
        wrongOptionsPool = [...islahatPadisahlari];
        
        // Eğer doğru cevap (örn: III. Selim) listemizde yoksa format farkı olmasın diye ekle
        // Amaç: Doğru cevap "III. Selim (18. YY)" ise ve listede sadece "III. Selim" varsa hile olmasın.
        // Ancak basitlik adına, veritabanındaki cevap aynen korunacak, yanlış şıklar listeden gelecek.
    } 
    else if (sourceMenu === 'siyasi_menu') {
        // Siyasi tarih için yine veritabanındaki siyasi cevapları kullanmaya devam ediyoruz
        ['osmanli_kurulus', 'osmanli_yukselis', 'osmanli_duraklama', 'osmanli_gerileme', 'osmanli_dagilma', 'osmanli_20yy'].forEach(key => {
            if (database[key]) {
                wrongOptionsPool = wrongOptionsPool.concat(database[key].map(item => item.meaning));
            }
        });
    } 
    else {
    ...
    // Doğru cevabı yanlış şık havuzundan çıkar (Çakışma olmasın)
    // Not: Tam eşleşme olmasa bile (örn: "III. Selim" vs "III. Selim (18. YY)") metin içeriyorsa çıkaralım
    wrongOptionsPool = wrongOptionsPool.filter(opt => !correctMeaning.includes(opt) && !opt.includes(correctMeaning));
    
    // Benzersiz yap
    wrongOptionsPool = [...new Set(wrongOptionsPool)];
    
    // Rastgele 3 yanlış cevap seç
    const shuffledIncorrect = shuffleArray(wrongOptionsPool).slice(0, 3);
    
    // Doğru cevabı ve yanlışları birleştir
    let options = [correctMeaning, ...shuffledIncorrect];
    options = shuffleArray(options); // Şıkları karıştır
    ...
    options.forEach(option => {
        ...
        btn.onclick = () => checkAnswer(btn, option, correctMeaning);
...
function checkAnswer(button, selectedAnswer, correctAnswer) {
    ...
    const feedbackMsg = document.getElementById('quiz-feedback');
    const scoreBoard = document.getElementById('score-val');

    if (selectedAnswer === correctAnswer) {
        button.classList.add('correct');
        feedbackMsg.innerText = "✅ Doğru!";
        quizScore++;
        scoreBoard.innerText = quizScore;
    } else {
        button.classList.add('wrong');
        feedbackMsg.innerText = `❌ Yanlış! Doğru cevap: ${correctAnswer}`;
    ...
    autoTimer = setTimeout(() => {
        loadQuizQuestion(quizSourceCategory);
    }, 3000);
}
...
function goBackFromQuiz() {
    ...
    if (quizSourceCategory === 'islahat_menu') {
         document.getElementById('islahat-submenu').style.display = 'flex';
    } else if (quizSourceCategory === 'siyasi_menu') {
         document.getElementById('siyasi-submenu').style.display = 'flex';
    } else {
...
function backToMainMenu() {
    ...
    document.getElementById('siyasi-submenu').style.display = 'none';
    document.getElementById('menu-screen').style.display = 'flex';
}
...
function startQuizMode() {
    ...
    currentList = shuffleArray(allIslahatWords);
    quizScore = 0;
    document.getElementById('score-val').innerText = quizScore;
    document.getElementById('menu-screen').style.display = 'none';
    document.getElementById('islahat-submenu').style.display = 'none';
    document.getElementById('quiz-screen').style.display = 'flex';
    loadQuizQuestion("islahat_menu");
}

function startSiyasiQuizMode() {
    let allSiyasiWords = [
        ...database['osmanli_kurulus'],
        ...database['osmanli_yukselis'],
        ...database['osmanli_duraklama'],
        ...database['osmanli_gerileme'],
        ...database['osmanli_dagilma'],
        ...database['osmanli_20yy']
    ];
    currentList = shuffleArray(allSiyasiWords);
    quizScore = 0;
    document.getElementById('score-val').innerText = quizScore;
    document.getElementById('menu-screen').style.display = 'none';
    document.getElementById('siyasi-submenu').style.display = 'none';
    document.getElementById('quiz-screen').style.display = 'flex';
    loadQuizQuestion("siyasi_menu");
}


// ==========================================
// OYUNU BAŞLATMA VE HATA YAKALAMA
// ==========================================

function startGame(categoryKey) {
    try {
        console.log("Oyun başlatılıyor: " + categoryKey); // Debug için
        ...
        if (categoryKey === 'islahat_all') {
        ...
        } else if (categoryKey === 'osmanli_all') { 
            currentList = [
                ...database['osmanli_kurulus'],
                ...database['osmanli_yukselis'],
                ...database['osmanli_duraklama'],
            ...
            document.getElementById('topic-title').innerText = "Tüm Osmanlı Siyasi Tarihi";
        } else {
            // HATA KONTROLÜ: Eğer veritabanında bu anahtar yoksa uyar
            if (!database[categoryKey]) {
                alert("HATA: '" + categoryKey + "' veritabanında bulunamadı! Lütfen kodları kontrol et.");
                return;
            }
            ...
            const titles = {
                ...
                "osmanli_kurulus": "Osmanlı Kuruluş Dönemi",
                "osmanli_yukselis": "Osmanlı Yükseliş Dönemi",
                "osmanli_duraklama": "Osmanlı Duraklama Dönemi",
                "osmanli_gerileme": "Osmanlı Gerileme Dönemi",
                "osmanli_dagilma": "Osmanlı Dağılma Dönemi",
                "osmanli_20yy": "XX. Yüzyıl Başları Osmanlı",
            ...
            document.getElementById('topic-title').innerText = titles[categoryKey] || "Konu Başlığı";
        }

        // Liste boş mu kontrol et
        if (currentList.length === 0) {
            alert("Bu kategori için henüz soru eklenmemiş!");
            return;
        }
        
        // Ekran Geçişi - Tüm diğer ekranları gizle
        document.getElementById('menu-screen').style.display = 'none';
        document.getElementById('islahat-submenu').style.display = 'none';
        document.getElementById('siyasi-submenu').style.display = 'none';
...
function goBack() {
    ...
    // Geri dönerken doğru menüye yönlendir
    if (topicTitle.includes("Islahatları")) {
        document.getElementById('islahat-submenu').style.display = 'flex';
    } else if (topicTitle.includes("Osmanlı") && !topicTitle.includes("Kültür")) {
        // "Osmanlı Kültür" değilse ve "Osmanlı" içeriyorsa Siyasi Tarihtir
        document.getElementById('siyasi-submenu').style.display = 'flex';
    } else {
        document.getElementById('menu-screen').style.display = 'flex';
    }
...
function drawPaper() {
    ...
    meaningBtn.innerText = "CEVABI GÖSTER";
